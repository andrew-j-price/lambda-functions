...
# function:random_string_py
function_random_string_py: random_string_py_run line_breaks1 random_string_py_test line_breaks2 random_string_py_black_check line_breaks3 random_string_py_flake8

random_string_py_run:
	docker compose exec -T pyfunctions python /git/random_string_py/lambda_function.py

random_string_py_test:
	docker compose exec -T pyfunctions pytest --verbose /git/random_string_py/test_lambda_function.py

random_string_py_black_apply:
	docker compose exec -T pyfunctions black --line-length 120 /git/random_string_py/lambda_function.py && \
	docker compose exec -T pyfunctions black --line-length 120 /git/random_string_py/test_lambda_function.py

random_string_py_black_check:
	docker compose exec -T pyfunctions black --check --line-length 120 /git/random_string_py/lambda_function.py && \
	docker compose exec -T pyfunctions black --check --line-length 120 /git/random_string_py/test_lambda_function.py

random_string_py_flake8:
	docker compose exec -T pyfunctions flake8 --max-line-length 120 /git/random_string_py/lambda_function.py && \
	docker compose exec -T pyfunctions flake8 --max-line-length 120 /git/random_string_py/test_lambda_function.py
